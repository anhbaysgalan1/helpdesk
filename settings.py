...
QUEUE_EMAIL_BOX_HOST = getattr(settings, 'QUEUE_EMAIL_BOX_HOST', 'gmail.com')
QUEUE_EMAIL_BOX_USER = getattr(settings, 'QUEUE_EMAIL_BOX_USER', 'imadlz15@gmail.com')
QUEUE_EMAIL_BOX_PASSWORD = getattr(settings, 'QUEUE_EMAIL_BOX_PASSWORD', 'ny.4mans')
...
EMAIL_HOST_USER = 'imadlz15@gmail.com'
EMAIL_HOST_PASSWORD = 'ny.4mans'